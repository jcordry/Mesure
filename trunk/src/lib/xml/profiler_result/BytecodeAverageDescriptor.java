...
/**
 * Class BytecodeAverageDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class BytecodeAverageDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BytecodeAverageDescriptor() 
     {
        super();
        xmlName = "BytecodeAverage";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BytecodeAverage target = (BytecodeAverage) object;
    ...
    } //-- lib.xml.profiler_result.BytecodeAverageDescriptor()
    ...
    {
        return lib.xml.profiler_result.BytecodeAverage.class;
