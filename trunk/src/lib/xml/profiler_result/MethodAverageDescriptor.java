...
/**
 * Class MethodAverageDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class MethodAverageDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MethodAverageDescriptor() 
     {
        super();
        xmlName = "MethodAverage";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                MethodAverage target = (MethodAverage) object;
    ...
    } //-- lib.xml.profiler_result.MethodAverageDescriptor()
    ...
    {
        return lib.xml.profiler_result.MethodAverage.class;
