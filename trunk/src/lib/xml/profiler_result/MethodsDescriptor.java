...
public class MethodsDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MethodsDescriptor() 
     {
        ...
        //-- _methodList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(lib.xml.profiler_result.Method.class, "_methodList", "Method", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Methods target = (Methods) object;
                    target.addMethod( (lib.xml.profiler_result.Method) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new lib.xml.profiler_result.Method();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- lib.xml.profiler_result.MethodsDescriptor()
    ...
    {
        return lib.xml.profiler_result.Methods.class;
